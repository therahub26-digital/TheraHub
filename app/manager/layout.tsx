...
export default async function ManagerLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <Shell role="manager" scopeLabel={PRIMARY_OUTLET.name} scopeSub={PRIMARY_OUTLET.city} brandKey={theme.brandKey} bgKey={theme.bgKey} notificationCount={pendingExtensions} notificationHref="/manager/sessions">
