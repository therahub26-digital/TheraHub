...
import {
  ...
  Star, Sun, Timer, TrendingDown, TrendingUp, Ticket, Trash2, Truck, User, UserCheck,
...
const MAP: Record<string, React.ComponentType<{ size?: number | string; strokeWidth?: number; className?: string; style?: React.CSSProperties }>> = {
  ...
  ticket: Ticket, timer: Timer, trash: Trash2, "trending-down": TrendingDown,
  "trending-up": TrendingUp, truck: Truck, upload: Upload, user: User, "user-check": UserCheck,
  "user-round": UserRound, users: Users, utensils: Utensils, wallet: Wallet, waves: Waves,
  wifi: Wifi, "wifi-off": WifiOff, wrench: Wrench, x: X, "x-circle": XCircle, zap: Zap,
