...
//
// Panel uses components/FloatingPanel.tsx — added 2026-08-24. Every
// trigger here sits inside a `.card`, and `.card` is `overflow: hidden`
// (app/ui.css), which silently clips a plain `position: absolute` panel
// to invisibility the moment it opens — this is the same root cause as
// the room/outlet "Edit tidak fungsi" report the same day. Portaling to
// document.body escapes that clipping regardless of which card the
// trigger sits in.
// ---------------------------------------------------------------------
